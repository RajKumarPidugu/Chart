...
})({"hQhZw":[function(require,module,exports) {
...
},{}],"idZQs":[function(require,module,exports) {
 ...
 */ const displayErrorMessage = ()=>{
    ...
    if (appDiv) appDiv.innerHTML = "<p>Failed to load data. Please try again later.</p>";
};
/**
 * Shows a loading spinner.
 */ const showLoadingSpinner = ()=>{
    const appDiv = document.getElementById("app");
    if (appDiv) appDiv.innerHTML = '<div class="spinner"></div>';
};
/**
 * Hides the loading spinner.
 */ const hideLoadingSpinner = ()=>{
    const appDiv = document.getElementById("app");
    if (appDiv) appDiv.innerHTML = '<canvas id="barChart"></canvas>';
};
// Run the main function
main();

},{"chart.js/auto":"d8NN9","./style.css":"dRy26"}],"d8NN9":[function(require,module,exports) {
...
},{}],"dRy26":[function() {},{}]},["hQhZw","idZQs"], "idZQs", "parcelRequiref1b2")
